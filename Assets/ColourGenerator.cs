...
public class ColourGenerator 
{
    ...
    public float BiomePercentFromPoint(Vector3 pointOnUnitShere)
    {
        float heightPercent = (pointOnUnitShere.y + 1) / 2f;
        heightPercent += (biomeNoiseFilter.Evaluate(pointOnUnitShere) - settings.biomeColourSettings.noiseOffset) * settings.biomeColourSettings.noiseStrength;
        float biomeIndex = 0;
